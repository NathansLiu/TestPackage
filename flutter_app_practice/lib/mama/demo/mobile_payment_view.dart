...
class MobilePaymentView extends StatefulWidget {
  @override
...
class MobilePaymentContent extends State<MobilePaymentView> {
  @override
...
Widget _widgetChest() {
  return new Column(
    children: <Widget>[
      _widgetHeadPortrait(),
      new Flexible(child: _widgetList()),
      _widgetIntegral(),
      _widgetGuideNote()
    ],
  );
...
setPayLiatBean() {
  ...
  listPayShopBean.add(PayUserBean('MUTUKI纸尿裤钻石版MUTUKI纸尿裤钻石版MUTUKI纸尿裤钻石版MUTUKI纸尿裤钻石版', '￥80.00', '白色,L', 'x2'));
